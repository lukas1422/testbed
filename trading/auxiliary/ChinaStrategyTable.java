...
//                case 8:
//                    return transform3P(ChinaData.strategyTotalMap.get(name), StratType.VOL, AllData.priceMapBar.get(name));
//                case 9:
//                    return transform3P(ChinaData.strategyTotalMap.get(name), StratType.MA, AllData.priceMapBar.get(name));
//                case 10:
//                    return transform3P(ChinaData.strategyTotalMap.get(name), StratType.PRICEBURST, AllData.priceMapBar.get(name));
//                case 11:
