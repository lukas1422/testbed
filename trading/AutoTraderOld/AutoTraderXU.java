...
//import static api.ChinaPosition.getNetPtfDelta;
...
//                .filter(e -> e.getValue().getAugmentedOrderStatus() == Filled)
//                .mapToDouble(e -> e.getValue().getOrder().totalQuantity().longValue()).sum();
//
//        if (soldUnits == 0.0) {
//            return 0.0;
//        }
...
//                .filter(e -> e.getValue().getOrder().action() == Types.Action.SELL)
//                .filter(e -> e.getValue().getAugmentedOrderStatus() == Filled)
//                .mapToDouble(e -> e.getValue().getOrder().totalQuantity().longValue() * e.getValue().getOrder().lmtPrice())
//                .sum() / soldUnits;
//    }
//
//    @SuppressWarnings("SameParameterValue")
...
//    private void loadXU() {
//        //pr("in loadXU");
//        AllData.GLOBAL_REQ_ID.addAndGet(5);
//        TradingUtility.getSGXA50Historical2(controller(), AllData.GLOBAL_REQ_ID.get(), this);
//    }
//
