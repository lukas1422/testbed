...
//
//import static AutoTraderOld.XuTraderHelper.sessionOpenT;
...
//                //check totall quantity has sign? 23 11 06
//                .mapToDouble(e -> e.getValue().getOrder().totalQuantity().value().doubleValue())
//                .sum();
//    }
//
