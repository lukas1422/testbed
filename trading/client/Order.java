...
public class Order {
    ...
    public Types.Action action() {
        return Types.Action.get(m_action);
    }
    ...
    public Types.Method faMethod() {
        return Types.Method.get(m_faMethod);
    }
    ...
    public Types.OcaType ocaType() {
        return Types.OcaType.get(m_ocaType);
    }
    ...
    public Types.Rule80A rule80A() {
        return Types.Rule80A.get(m_rule80A);
    }
    ...
    public Types.AlgoStrategy algoStrategy() {
        return Types.AlgoStrategy.get(m_algoStrategy);
    }
    ...
    public Types.HedgeType hedgeType() {
        return Types.HedgeType.get(m_hedgeType);
    }
    ...
    public Types.TimeInForce tif() {
        return Types.TimeInForce.get(m_tif);
    }
    ...
    public Types.VolatilityType volatilityType() {
        return Types.VolatilityType.get(m_volatilityType);
    }
    ...
    public Types.TriggerMethod triggerMethod() {
        return Types.TriggerMethod.get(m_triggerMethod);
    }
    ...
    public Types.ReferencePriceType referencePriceType() {
        return Types.ReferencePriceType.get(m_referencePriceType);
    }
    ...
    public boolean isOmsContainer() {
        return m_isOmsContainer;
    }

    public boolean discretionaryUpToLimitPrice() {
        return m_discretionaryUpToLimitPrice;
    }

    public String autoCancelDate() {
        return m_autoCancelDate;
    }
    ...
    public boolean imbalanceOnly() {
        return m_imbalanceOnly;
    }

    public boolean routeMarketableToBbo() {
        return m_routeMarketableToBbo;
    }

    public long parentPermId() {
        return m_parentPermId;
    }

    public Boolean usePriceMgmtAlgo() {
        return m_usePriceMgmtAlgo;
    }
    ...
    public String advancedErrorOverride() {
        return m_advancedErrorOverride;
    }

    public String manualOrderTime() {
        return m_manualOrderTime;
    }

    public int minTradeQty() {
        return m_minTradeQty;
    }

    public int minCompeteSize() {
        return m_minCompeteSize;
    }

    public double competeAgainstBestOffset() {
        return m_competeAgainstBestOffset;
    }

    public boolean isCompeteAgainstBestOffsetUpToMid() {
        return m_competeAgainstBestOffset == COMPETE_AGAINST_BEST_OFFSET_UP_TO_MID;
    }

    public double midOffsetAtWhole() {
        return m_midOffsetAtWhole;
    }

    public double midOffsetAtHalf() {
        return m_midOffsetAtHalf;
    }
    ...
    public void action(Types.Action v) {
    ...
    public void algoStrategy(Types.AlgoStrategy v) {
    ...
    public void faMethod(Types.Method v) {
    ...
    public void hedgeType(Types.HedgeType v) {
    ...
    public void ocaType(Types.OcaType v) {
    ...
    public void referencePriceType(Types.ReferencePriceType v) {
    ...
    public void rule80A(Types.Rule80A v) {
    ...
    public void tif(Types.TimeInForce v) {
    ...
    public void totalQuantity(Decimal v) {
        m_totalQuantity = v;
    }
    ...
    public void triggerMethod(Types.TriggerMethod v) {
    ...
    public void volatilityType(Types.VolatilityType v) {
    ...
    public void isOmsContainer(boolean v) {
        m_isOmsContainer = v;
    }

    public void discretionaryUpToLimitPrice(boolean v) {
        m_discretionaryUpToLimitPrice = v;
    }

    public void autoCancelDate(String v) {
        m_autoCancelDate = v;
    }

    public void filledQuantity(Decimal v) {
        m_filledQuantity = v;
    }

    public void refFuturesConId(int v) {
        m_refFuturesConId = v;
    }

    public void autoCancelParent(boolean v) {
        m_autoCancelParent = v;
    }

    public void shareholder(String v) {
        m_shareholder = v;
    }

    public void imbalanceOnly(boolean v) {
        m_imbalanceOnly = v;
    }

    public void routeMarketableToBbo(boolean v) {
        m_routeMarketableToBbo = v;
    }

    public void parentPermId(long v) {
        m_parentPermId = v;
    }

    public void usePriceMgmtAlgo(Boolean v) {
        m_usePriceMgmtAlgo = v;
    }

    public void duration(int v) {
        m_duration = v;
    }

    public void postToAts(int v) {
        m_postToAts = v;
    }

    public void advancedErrorOverride(String v) {
        m_advancedErrorOverride = v;
    }

    public void manualOrderTime(String v) {
        m_manualOrderTime = v;
    }

    public void minTradeQty(int v) {
        m_minTradeQty = v;
    }

    public void minCompeteSize(int v) {
        m_minCompeteSize = v;
    }

    public void competeAgainstBestOffset(double v) {
        m_competeAgainstBestOffset = v;
    }

    public void setCompeteAgainstBestOffsetUpToMid() {
        m_competeAgainstBestOffset = COMPETE_AGAINST_BEST_OFFSET_UP_TO_MID;
    }

    public void midOffsetAtWhole(double v) {
        m_midOffsetAtWhole = v;
    }

    public void midOffsetAtHalf(double v) {
        m_midOffsetAtHalf = v;
    }
...
//                "Q:" + m_totalQuantity, "px:" + m_lmtPrice, "filledQ:" + m_filledQuantity);
        ...
        return str("orderID:" + m_orderId, m_orderType, m_action, "Q:" + m_totalQuantity, "px:" + m_lmtPrice);
    }
