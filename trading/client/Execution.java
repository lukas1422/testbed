...
public class Execution {
    ...
    public String lastLiquidityStr() {
        return m_lastLiquidity.toString();
    }

    public boolean pendingPriceRevision() {
        return m_pendingPriceRevision;
    }
    ...
    public void shares(Decimal shares) {
        m_shares = shares;
    }
    ...
    public void cumQty(Decimal cumQty) {
        m_cumQty = cumQty;
    }
    ...
    public void pendingPriceRevision(boolean pendingPriceRevision) {
