...
public class OrderState {
    ...
    public void completedTime(String v) {
        m_completedTime = v;
    }

    public void completedStatus(String v) {
        m_completedStatus = v;
    }
    ...
    public String toString() {
        return str("ORDERSTATE toString:", "commission:", m_commission, "completedTime:", m_completedTime,
