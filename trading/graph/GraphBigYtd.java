...
//
//        Entry<LocalTime, SimpleBar> maxY2 = tmY2.entrySet().stream()
//                .max(Comparator.comparingDouble(e -> e.getValue().getHigh())).orElse(defaultEntry);
//        Entry<LocalTime, SimpleBar> minY2 = tmY2.entrySet().stream()
//                .min(Comparator.comparingDouble(e -> e.getValue().getLow())).orElse(defaultEntry);
//
//        Entry<LocalTime, SimpleBar> maxYtd = tmYtd.entrySet().stream()
//                .max(Comparator.comparingDouble(e -> e.getValue().getHigh())).orElse(defaultEntry);
//        Entry<LocalTime, SimpleBar> minYtd = tmYtd.entrySet().stream()
//                .min(Comparator.comparingDouble(e -> e.getValue().getLow())).orElse(defaultEntry);
//
//        Entry<LocalTime, SimpleBar> maxT = tm.entrySet().stream()
//                .filter(e -> e.getKey().isAfter(LocalTime.of(9, 29)))
//                .max(Comparator.comparingDouble(e -> e.getValue().getHigh())).orElse(defaultEntry);
//        Entry<LocalTime, SimpleBar> minT = tm.entrySet().stream()
//                .filter(e -> e.getKey().isAfter(LocalTime.of(9, 29)))
//                .min(Comparator.comparingDouble(e -> e.getValue().getLow())).orElse(defaultEntry);
//
...
//
//    double getMinVol() {
//        return Math.min(tmVolYtd.entrySet().stream().min(Entry.comparingByValue()).map(Entry::getValue).orElse(0.0),
//                tmVol.entrySet().stream().min(Entry.comparingByValue()).map(Entry::getValue).orElse(0.0));
//    }
//
