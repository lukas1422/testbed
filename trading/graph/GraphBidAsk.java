...
//            tmBid = new TreeMap<>(ChinaData.bidMap.get(nam).entrySet().stream().collect(Collectors.toMap(Entry::getKey,
...
//
//            tmAsk = new TreeMap<>(ChinaData.askMap.get(nam).entrySet().stream().collect(Collectors.toMap(Entry::getKey,
//                    e -> ind1.getV() * e.getValue().getL1() + ind2.getV() * e.getValue().getL2() + ind3.getV() * e.getValue().getL3() + ind4.getV() * e.getValue().getL4() + ind5.getV() * e.getValue().getL5())));
//
//        }
