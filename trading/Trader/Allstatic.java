...
public class Allstatic {
    ...
    static final double CURRENT_PARTITION = 6.0; //refill times now due to limited delta
    static final double IDEAL_PARTITION = 20.0; //ideally how many times to refill
